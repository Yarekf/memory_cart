...
questions_list.append(
        Question('Самая высокая башня в мире', 'Бурдж-Халифа', 'Пизанская башня', 'Эйфелева Башня', 'Останкинская башня'))
questions_list.append(
        Question('Язык которого никогда не было в мире', 'Бразильский', 'Русский', 'Эсперанто', 'Англиский'))
questions_list.append(
        Question('Страна которой больше нет', 'Османская империя', 'Болгария', 'Украина', 'Ватикан'))
